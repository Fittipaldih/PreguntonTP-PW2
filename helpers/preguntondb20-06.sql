...
-- Tiempo de generación: 20-06-2023 a las 21:46:47
...
(1, '¿Cuál es el elemento químico más abundante en el universo?', 3, 1, 96, 45, 47, 'Hidrógeno', 'Oxígeno', 'Carbono', 'Hierro', 'A'),
(2, '¿Cuál es el río más largo del mundo?', 2, 1, 100, 61, 61, 'Amazonas', 'Nilo', 'Yangtsé', 'Misisipi', 'B'),
(3, '¿Cuál es la capital de Australia?', 2, 1, 98, 49, 50, 'Sídney', 'Melbourne', 'Brisbane', 'Canberra', 'D'),
(4, '¿Cuál es el planeta más grande del sistema solar?', 3, 1, 99, 49, 49, 'Mercurio', 'Venus', 'Júpiter', 'Marte', 'C'),
(5, '¿Cuál es la montaña más alta del mundo?', 2, 1, 98, 58, 59, 'Mont Blanc', 'K2', 'Everest', 'Aconcagua', 'C'),
(6, '¿Cuál es el país más poblado del mundo?', 2, 1, 96, 49, 51, 'Estados Unidos', 'China', 'India', 'Brasil', 'B'),
(7, '¿Cuál es el símbolo químico del oro?', 2, 1, 96, 60, 63, 'Au', 'Ag', 'Fe', 'Hg', 'A'),
(8, '¿Cuál es el océano más grande del mundo?', 2, 1, 98, 57, 58, 'Atlántico', 'Pacífico', 'Índico', 'Ártico', 'B'),
(9, '¿Cuál es el animal terrestre más grande del mundo?', 2, 1, 97, 60, 62, 'Jirafa', 'Rinoceronte blanco', 'Elefante africano', 'Oso polar', 'C'),
(10, '¿Cuál es el compuesto químico principal que constituye la atmósfera terrestre?', 2, 1, 101, 47, 47, 'Nitrógeno', 'Oxígeno\n', 'Dióxido de carbono\n', 'Argón', 'A');
...
(12, 'Marianita Aquino', '2001-03-23', 'Femenino', 1, 0.00000000000000000000, 0.00000000000000000000, 'maraquino@gmail.com', 'Mar', '', 3, '7ce6b2286a5396e614b8484105d277e0', '81dc9bdb52d04dc20036dbd8313ed055', '7', 62, 34, 21),
(80, 'Hernan', '1996-09-17', 'Masculino', 1, -34.69891451120487000000, -58.50764973161350500000, 'fittipaldi.h@gmail.com', 'Fitti', '', 3, 'c2dfb0b48d36edab65407c6a074a5170', '81dc9bdb52d04dc20036dbd8313ed055', '3', 57, 590, 334),
