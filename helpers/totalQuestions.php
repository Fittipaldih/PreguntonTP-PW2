...
require('third-party/fpdf-tutoriales-master/fpdf.php');
...
class PDF extends fpdf
{
    ...
    function Header()
    {
        $this->Image('third-party/fpdf-tutoriales-master/logo2.png', 110, 5, 80); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
