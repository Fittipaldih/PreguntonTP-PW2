...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2023 a las 00:53:35
...
INSERT INTO `pregunta` (`id`, `descripcion`, `estado`, `id_partida`, `id_categoria`, `id_respuesta`, `veces_mostrada`, `veces_correcta`, `porc_correc`) VALUES
(1, '¿Cuál es el elemento químico más abundante en el universo?', 0, 0, 0, 2, 12, 4, 33),
(2, '¿Cuál es el río más largo del mundo?', 0, 0, 0, 3, 14, 7, 50),
(3, '¿Cuál es la capital de Australia?', 0, 0, 0, 4, 13, 4, 31),
(4, '¿Cuál es el planeta más grande del sistema solar?', 0, 0, 0, 5, 14, 8, 57),
(5, '¿Cuál es la montaña más alta del mundo?', 0, 0, 0, 6, 12, 7, 58),
(6, '¿Cuál es el país más poblado del mundo?', 0, 0, 0, 7, 12, 4, 33),
(7, '¿Cuál es el símbolo químico del oro?', 0, 0, 0, 8, 11, 5, 45),
(8, '¿Cuál es el océano más grande del mundo?', 0, 0, 0, 9, 12, 6, 50),
(9, '¿Cuál es el animal terrestre más grande del mundo?', 0, 0, 0, 10, 13, 5, 38),
(10, '¿Cuál es el compuesto químico principal que constituye la atmósfera terrestre?', 0, 0, 0, 11, 18, 4, 22);
...
(37, 'Lisandro Menu', '2003-01-28', 'Masculino', 'Argentina', 'Santa Rosa', 'lisandro@hotmail.com', 'lisandro', 'charizard_f.gif', 3, '85133e07ba49e25e70d977345ccdaef7', 'e120ea280aa50693d5568d0071456460', '3', 38, 124, 47);
